...
with DAG(
    ...
    stock_table = "USER_DB_PANDA.RAW.stock_price"   # Using the same schema from ETL
    train_view = "USER_DB_PANDA.RAW.stock_price_view"
    forecast_table = "USER_DB_PANDA.RAW.stock_forecast"
    forecast_function = "USER_DB_PANDA.RAW.predict_stock_price"
    final_table = "USER_DB_PANDA.RAW.stock_final"
